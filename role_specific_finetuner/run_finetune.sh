...
python3 train.py \
--sanity_run yes \
--train_path 'data/xalign_transliterated_facts/train.csv' \
--val_path 'data/xalign_transliterated_facts/val.csv' \
--test_path 'data/xalign_transliterated_facts/test.csv' \
...
--project_name 'swft' \
--run_name 'finetuning_only_copy_mechanism'
